    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "files": ("GEMINI_INPUT_FILES", {"default": None, "tooltip": "Packed multi-image files input"}),
            },
            "hidden": {
                "unique_id": "UNIQUE_ID",
            }
    ...
    def generate_image(
        ...
        try:
            if is_edit_mode:
                ...
                response = post_with_retries(url, headers, data=data, files=request_files, timeout=300)
            else:
