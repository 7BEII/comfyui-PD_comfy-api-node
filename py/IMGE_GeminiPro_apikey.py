...
class PDGeminiProImageGenAPIKey:
    ...
    def generate_image(self, api_key, prompt, model, aspect_ratio, resolution, response_modalities, seed, unique_id, images=None, system_prompt=""):
        """生成图片"""
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "PDGeminiProImageGenAPIKey": "PD: Gemini Pro Image (apikey)"
}
